  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          Select the date you want to fix the <b>{type}</b> compliance filing on
          the calendar.
        </p>
        <input
          type="date"
...
const ComplianceCalendarPage = () => {
  ...
  const [calendarEvents, setCalendarEvents] = useState({
    "2025-10-5": [
      { label: "ESI", color: COLORS.esi, title: "ESI - Due on November 5" },
    ],
    "2025-10-11": [
      { label: "GST", color: COLORS.gst, title: "GST - Due on November 11" },
    ],
    "2025-10-20": [
      { label: "GST", color: COLORS.gst, title: "GST - Due on November 20" },
    ],
  });
  ...
  const renderCalendarGrid = () => {
    ...
    for (let d = 1; d <= totalDays; d++) {
      ...
      cells.push(
        <CalendarDayCell key={d} day={d} events={events} isToday={isToday} />
      );
    }
      ...
      <main style={{ flex: 1, overflowY: "auto", padding: "24px" }}>
        <div style={{ display: "flex", flexDirection: "column", gap: "24px" }}>
          ...
          >
            ...
            >
              Tip: Use the AGM Scheduler to set precise AGM dates and
              automatically calculate accurate MCA compliance deadlines.
            </p>
          </div>
          <div
            style={{
